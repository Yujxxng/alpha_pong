	...
	_In_ int       nCmdShow)
{
	...
	//LogicComponentManager* Logic = LogicComponentManager::getPtr();
	//EngineComponentManager* Engine = EngineComponentManager::getPtr();
	//GraphicComponentManager* Graphic = GraphicComponentManager::getPtr();
